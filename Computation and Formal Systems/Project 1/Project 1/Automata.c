...
// extern DFA NFAtoDFA(NFA nfa)         // My horrible, failed attempt at converting NFAs to DFAs.
// {                                    // I was running out of time so I kind of gave up on it. My deepest apologies.
//     bool isDFA = true;
//     for (int i=0; i<129; i++)
//     {
//         for (int j=0; j<nfa->size; j++)
